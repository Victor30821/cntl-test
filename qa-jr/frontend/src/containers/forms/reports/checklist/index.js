...
import ExportXLSX from '../../../../exports/xlsx/xlsx-report.export-checklists';
...
export default function ReportsChecklistForm ({
    formErrors,
    onSubmit,
    inputsConfig,
    formId,
    ...
    const XLSXexportJSX = () => {
        return (
            <XLSXExport
                document={docXlsx}
                fileName={`relatorio-checklist-${filters.period?.start_date}`}
            ...
            <Card >
                ...
                <CardForm id={formId} onSubmit={onSubmit}>
                    <Row>
                        <Col xl="4" xxl="3">
                            <Select
                                placeholder={localizedStrings.drivers}
                                name={"drivers"}
                                isMulti={true}
                                ...
                                ref={inputsConfig.register({ required: true })}
                                onChange={(list, selected) => handleDriver(list, selected)}
                            />
                            {formErrors.drivers && (
                                <Text textAlign="right" color="#FD3995">
                                    {localizedStrings.driversIsRequired}
                                </Text>
                            )}
                        </Col>
                        <Col xl="4" xxl="3">
                            <Select
                                placeholder={localizedStrings.vehicles}
                                name={"vehicles"}
                                isMulti={true}
                            ...
                            {formErrors.vehicles && (
                                <Text textAlign="right" color="#FD3995">
                                    {localizedStrings.vehiclesIsRequired}
                                </Text>
                            )}
                        </Col>
                        <Col xl="4" xxl="3">
